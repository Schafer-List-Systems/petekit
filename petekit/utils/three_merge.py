# -*- coding: utf-8 -*-
# This module is based on three-merge by Spyder Project Contributors.
# Licensed under the terms of the MIT License.
# Original source: https://github.com/spyder-ide/three-merge
# Thanks to the Spyder Project Contributors for this excellent algorithm.
#
# Modifications: added conflict detection flag, returns tuple[str, bool].
...
def merge(source: str, target: str, base: str) -> tuple[str, bool]:
    """
    Three-way merge: compute merged text and whether conflicts were detected.

    Based on three-merge by Spyder Project Contributors (MIT License).
